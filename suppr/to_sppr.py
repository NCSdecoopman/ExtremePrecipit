...
stations_presente_1 = set(zTp_1959_2022["NUM_POSTE"].unique())
stations_presente_2 = set(zTp_1990_2022["NUM_POSTE"].unique())
stations_communes = stations_presente_1 & stations_presente_2
print(f"Nombre de stations communes : {len(stations_communes)}")
...
for station_id in stations_communes:
    ...
    tol = 1e-6  # ou ajuste selon la précision souhaitée
    if not np.isclose(zTp_1959_2022_val, trend_1959, atol=tol) or not np.isclose(zTp_1990_2022_val, trend_1990, atol=tol):
        print(f"WARNING {station_id}")
        ...
        for year, color, z, label in [
            (1990, "blue", z_1959_2022, "fit 1959-2022"),
            (2022, "blue", z_1959_2022, "fit 1959-2022"),
            (1990, "red", z_1990_2022, "fit 1990-2022"),
