...
* **Why choose the hydrological year? The study itself does not take into account snowpack, and in addition the convective extreme precipitation can come in summer that in this study is over the start of the hydrological year (JAS, where summer usually is considered as JJA). This should be justified more.** 
  ...
  For **seasonal** analyses, we follow the conventional hydrological-season partition used in French hydrology: OND, JFM, AMJ, and JAS (three-month blocks aligned with the hydrological calendar). This differs from meteorological seasons (e.g., JJA for summer). We acknowledge that **JAS** therefore mixes late-summer convective activity (July–August) with early-autumn Mediterranean episodes (September), and does not correspond to meteorological summer. This is a limitation of the seasonal breakdown, not an inconsistency with the annual choice: the hydrological-year definition addresses block independence for annual maxima, whereas the seasonal partition is a separate convention for sub-annual aggregation.
  ...
  **Manuscript modifications:**
  In `Section 3 (Methodology)`, after the definition of seasons and the hydrological year, we have added the following clarification:

  > _"The hydrological year (September to August) is used for annual maxima instead of the calendar year, which is standard in French climatology and hydrology. This choice is motivated by the fact that the most intense extreme precipitation events in France, particularly Mediterranean episodes (e.g., Cévenol events), occur during autumn (September–November). Using a calendar year would risk splitting these autumn events across two years, violating the block-independence assumption required for annual maxima GEV modeling. Seasonal analyses follow the conventional hydrological-season partition (OND, JFM, AMJ, JAS), which differs from meteorological seasons: JAS groups late-summer and early-autumn activity and therefore does not correspond to meteorological summer (JJA). Monthly analyses are provided to examine summer and autumn convective regimes separately."_
