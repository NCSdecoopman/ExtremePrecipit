...
Globalement, AROME reproduit la distribution spatiale des tendances observées, mais avec une extension parfois réduite — sur les Alpes du Nord en automne et en hiver, ainsi que sur la moitié nord de la France au printemps — et sous‑estime systématiquement leur amplitude, avec un biais moyen compris entre −2,42% (MAM) et −4,87% (HYDRO).
