...
\includegraphics[width=\linewidth, trim=12 12 12 12, clip]{figures/jour_pluie.pdf} &
\includegraphics[width=\linewidth, trim=12 12 12 12, clip]{figures/mean_pluie_jour.pdf} &
\includegraphics[width=\linewidth, trim=12 12 12 12, clip]{figures/mean-max_pluie_jour.pdf} &
\includegraphics[width=\linewidth, trim=12 12 12 12, clip]{figures/mean-max_pluie_horaire.pdf} \\[-0.5mm]
...
\includegraphics[width=\linewidth, trim=12 12 12 12, clip]{figures/jour_pluie_diff.pdf} &
\includegraphics[width=\linewidth, trim=12 12 12 12, clip]{figures/mean_pluie_jour_diff.pdf} &
\includegraphics[width=\linewidth, trim=12 12 12 12, clip]{figures/mean-max_pluie_jour_diff.pdf} &
\includegraphics[width=\linewidth, trim=12 12 12 12, clip]{figures/mean-max_pluie_horaire_diff.pdf}
\end{tabular}
