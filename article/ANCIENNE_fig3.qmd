...
#   "../outputs/maps/stats_mean-max/quotidien/compare_9/sat_99.0/hydro/mod_rast.svg",
#   "../outputs/maps/stats_mean-max/quotidien/compare_9/sat_99.0/hydro/obs_rast.svg",
...
#   "../outputs/maps/stats_mean-max/horaire/compare_9/sat_99.0/hydro/mod_rast.svg",
#   "../outputs/maps/stats_mean-max/horaire/compare_9/sat_99.0/hydro/obs_rast.svg",
...
#   "../outputs/maps/stats_mean-max/quotidien/compare_9/sat_99.0/hydro/obs_rast_diff.svg",
...
#   "../outputs/maps/stats_mean-max/horaire/compare_9/sat_99.0/hydro/obs_rast_diff.svg",
...
r_mmj = float(df_mean_max_pluie_jour["r"].iloc[0]); n_mmj = int(df_mean_max_pluie_jour["n"].iloc[0])
r_mmh = float(df_mean_max_pluie_horaire["r"].iloc[0]); n_mmh = int(df_mean_max_pluie_horaire["n"].iloc[0])
...
me_mmj = float(df_mean_max_pluie_jour["me"].iloc[0]); d_mmj = float(df_mean_max_pluie_jour["delta"].iloc[0])
me_mmh = float(df_mean_max_pluie_horaire["me"].iloc[0]); d_mmh = float(df_mean_max_pluie_horaire["delta"].iloc[0])
```
...
\newcommand{{\rMeanMaxJour}}{{{r_mmj:.2f}}}
\newcommand{{\nMeanMaxJour}}{{{n_mmj:d}}}
\newcommand{{\rMeanMaxHoraire}}{{{r_mmh:.2f}}}
\newcommand{{\nMeanMaxHoraire}}{{{n_mmh:d}}}
...
\newcommand{{\meMeanMaxJour}}{{{me_mmj:+.2f}}}
\newcommand{{\dMeanMaxJour}}{{{d_mmj:+.2f}}}
\newcommand{{\meMeanMaxHoraire}}{{{me_mmh:+.2f}}}
\newcommand{{\dMeanMaxHoraire}}{{{d_mmh:+.2f}}}
"""
with open("macros_fig3.tex", "w", encoding="utf-8") as f:
    f.write(macros)
```
...
\includegraphics[width=\linewidth - 1.5mm, trim=14 0 0 0, clip]{figures/mean-max_pluie_jour.pdf} &
\includegraphics[width=\linewidth - 2.5mm, trim=14 0 0 0, clip]{figures/mean-max_pluie_horaire.pdf} \\[-0.5mm]

\small $r=\ \rJourPluie$ \ (n=\ \nJourPluie) &
\small $r=\ \rMeanPluieJour$ \ (n=\ \nMeanPluieJour) &
\small $r=\ \rMeanMaxJour$ \ (n=\ \nMeanMaxJour) &
\small $r=\ \rMeanMaxHoraire$ \ (n=\ \nMeanMaxHoraire) \\[-0.5mm]

\small $ME=\ \meJourPluie\,\mathrm{d}\,(\mathbf{\dJourPluie}\%)$ &
\small $ME=\ \meMeanPluieJour\,\mathrm{mm/yr}\,(\mathbf{\dMeanPluieJour}\%)$ &
\small $ME=\ \meMeanMaxJour\,\mathrm{mm/day}\,(\mathbf{\dMeanMaxJour}\%)$ &
\small $ME=\ \meMeanMaxHoraire\,\mathrm{mm/h}\,(\mathbf{\dMeanMaxHoraire}\%)$\\[-0.5mm]
...
\includegraphics[width=\linewidth - 1.5mm, trim=14 0 0 0, clip]{figures/mean-max_pluie_jour_diff.pdf} &
\includegraphics[width=\linewidth - 1.5mm, trim=14 0 0 0, clip]{figures/mean-max_pluie_horaire_diff.pdf}
\end{tabular}
