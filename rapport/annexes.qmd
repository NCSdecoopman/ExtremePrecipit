---
title: "Annexes 2 : figures"

table-of-contents: true
toc-depth: 2         # profondeur max (#, ##) –‑ optionnel*
toc-title: "Sommaire" 
...
def build_table(stats: str,
    ...
    for season in seasons:
        ...
        mod_path = base_season / "mod_norast.pdf"
        obs_path = base_season / "obs_norast.pdf"
        legend_path = base / comp / sat / "legend.pdf"
        metrics_path = base / comp / sat / "metrics.csv"
        ...
        row += (
            r"\end{tabular} & "
            rf"\centering \includegraphics[width=7.9cm]{{{mod_path}}} & "
            rf"\centering \includegraphics[width=7.9cm]{{{obs_path}}} & "
            rf"\centering \includegraphics[width=1cm]{{{legend_path}}} \tabularnewline"
        )
...
# Nombre moyen de jour de pluie (seuil 1 mm/j) par année hydrologique issu de Données journalières (1959-2022)
